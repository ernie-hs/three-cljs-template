...
var G__19233 = devtools.prefs.pref(v);
v = G__19233;
continue;
} else {
return v;
...
}catch (e19125){var _e__17961__auto__ = e19125;
return false;
}})();
...
}catch (e19127){var _e__17961__auto__ = e19127;
return false;
}})();
...
}catch (e19144){var _e__17961__auto__ = e19144;
return false;
}}
}
});
...
var vec__19172 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19172,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19172,(1),null);
...
return cljs.core.some((function (p1__19181_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__19181_SHARP_);
}),template);
});
