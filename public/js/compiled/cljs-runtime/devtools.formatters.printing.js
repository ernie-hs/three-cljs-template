...
var len__5726__auto___19369 = arguments.length;
var i__5727__auto___19370 = (0);
while(true){
if((i__5727__auto___19370 < len__5726__auto___19369)){
args__5732__auto__.push((arguments[i__5727__auto___19370]));

var G__19371 = (i__5727__auto___19370 + (1));
i__5727__auto___19370 = G__19371;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq19246){
var G__19247 = cljs.core.first(seq19246);
var seq19246__$1 = cljs.core.next(seq19246);
var G__19248 = cljs.core.first(seq19246__$1);
var seq19246__$2 = cljs.core.next(seq19246__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19247,G__19248,seq19246__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__19278_SHARP_){
return (!((cljs.core.meta(p1__19278_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19293__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e19294){var _e__17961__auto__ = e19294;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e19300){var _e__17961__auto__ = e19300;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__19312 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__19313 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__19313);

try{var map__19316 = opts;
var map__19316__$1 = cljs.core.__destructure_map(map__19316);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19316__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__19312);
}});
...
var temp__5802__auto___19394 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___19394)){
var managed_print_level_19395 = temp__5802__auto___19394;
var _STAR_print_level_STAR__orig_val__19352_19396 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__19353_19397 = managed_print_level_19395;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__19353_19397);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__19321_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__19321_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__19352_19396);
}} else {
job_fn();
}
