...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_23530 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_23530(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_23531 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_23531(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_23532 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_23532(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_23533 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_23533(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_23535 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_23535(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_23541 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_23541(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__23526,callback){
var map__23527 = p__23526;
var map__23527__$1 = cljs.core.__destructure_map(map__23527);
var input = map__23527__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23527__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23527__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
